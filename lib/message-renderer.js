    ...
    <div className={`message message-tool message-thinking ${collapsed}`} key={index}>
      <div className="tool-header">
        <span
          ...
          on={{ click: () => handlers?.toggle(msg.id) }}
        >
          Thinking
        </span>
        ...
        <div className="timeline-item timeline-last">
          ...
          <div className="timeline-content">
            <div className="message message-tool message-thinking thinking-streaming">
              ...
              <div className="thinking-content">
                <div className="message-content message-markdown" innerHTML={thinkingHtml} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="tip-section">
            ...
            <ul>
              ...
              <li
                ...
                on={{ click: () => atom.commands.dispatch(atom.views.getView(atom.workspace), "claude-chat:history") }}
              >
              ...
              {atom.packages.isPackageActive("pulsar-mcp") ? (
                <li
                  className="tip-clickable"
                  on={{ click: () => atom.commands.dispatch(atom.views.getView(atom.workspace), "pulsar-mcp:toggle-tools") }}
                >
