...
function renderAttachBadge(attach) {
  ...
  return (
    <span className="attach-badge" data-tooltip={tooltip}>
...
export function renderUserMessage(msg, index) {
  ...
  return (
    <div className="message message-user" key={index} data-tooltip={messageTimeTooltip(msg)}>
      <div className="message-role">
        You
        {renderAttachBadge(msg.attach)}
      </div>
      <div className="message-content message-markdown" dangerouslySetInnerHTML={{ __html: html }} />
    </div>
  );
}
  ...
  return (
    <div className={`message message-tool message-thinking ${collapsed}`} key={index}>
      <div className="tool-header">
        <span
          className="tool-name tool-toggle"
          onClick={() => handlers?.toggle(msg.id)}
        >
          Thinking
        </span>
        ...
        <div className="timeline-item timeline-last">
          ...
          <div className="timeline-content">
            <div className="message message-tool message-thinking thinking-streaming">
              ...
              <div className="thinking-content">
                <div className="message-content message-markdown" dangerouslySetInnerHTML={{ __html: thinkingHtml }} />
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="response-sequence" key={`response-${groupIndex}`}>
      {items.map((item, i) => {
        ...
        const tooltip = messageTimeTooltip(item);
      ...
      <div className="welcome-content">
        ...
        <div className="welcome-tips">
          <div className="tip-section">
            ...
            <ul>
              ...
              <li
                ...
                onClick={() => atom.commands.dispatch(atom.views.getView(atom.workspace), "claude-chat:history")}
              >
              ...
              {atom.packages.isPackageActive("pulsar-mcp") ? (
                <li
                  className="tip-clickable"
                  onClick={() => atom.commands.dispatch(atom.views.getView(atom.workspace), "pulsar-mcp:toggle-tools")}
                >
          ...
          <div className="tip-section">
            ...
            <ul>
              <li>
                <kbd>Ctrl+0</kbd> Cycle effort: Low, Medium, High
              </li>
              <li>
