...
export default class ChatPanel {
  ...
  async toggleBypassMode() {
    ...
    const nextMode = isBypassMode
      ? this.previousPermissionMode || (configuredMode === "bypassPermissions" ? "default" : configuredMode)
      : "bypassPermissions";
  ...
  return (
    <div className="permission-prompt">
      ...
      <div className="permission-prompt-actions">
        ...
        {hasEditorInput ? (
          <button className="btn btn-warning" onClick={() => callbacks.handlePermissionDenyWithReason()}>
            Deny with Note
          </button>
        ) : null}
